...
class SpringBootWithH2DbApplicationTests {
	...
	@Value("${Spring-Boot_with_H2-db.services.url}")
	private String baseURL;

	@Test
	public void test_getStudent() {
		RestTemplate restTemplate = new RestTemplate();
		Student _student = restTemplate.getForObject(baseURL + "getPassByEmail/ssm@gmail.com", Student.class);
	...
	public void test_updateStudent() {
		RestTemplate restTemplate = new RestTemplate();
		Student student = restTemplate.getForObject(baseURL + "getPassByEmail/ssm@gmail.com", Student.class);
